...
//
        ...
        //Blanchard Hall
        polyOpt = new PolygonOptions().add(new LatLng( 41.868557,  -88.099504), new LatLng(  41.86838384,-88.099504), new LatLng(  41.868602,  -88.099689), new LatLng(  41.868607,  -88.099493));
        polyOpt.strokeWidth(strokeWidth);
        polyOpt.fillColor(bHighlightOrange);
        poly = mMap.addPolygon(polyOpt);
        poly.setVisible(false);
        bInsert = new Building(poly, "BlanchardHall");
        allLocations.put(bInsert.getName(), bInsert);
